...
*/
import istic.TableauKanban.DAO.KanbanDao;
import istic.TableauKanban.DAO.SectionDao;
import istic.TableauKanban.Metier.Fiche;
...
public static void main(String[] args) {
      /* EntityManagerFactory factory = Persistence
    	...
    	kanban.setNom("TP TAA");
    	dao.save(kanban);
    	
    	KanbanDao dao1 = new KanbanDao();
       	Kanban kanban1 = new Kanban();
       	kanban1.setNom("TP GLI");
       	dao1.save(kanban1);
    	
       	
    	KanbanDao dao6 = new KanbanDao();
       	Kanban kanban2 = new Kanban();
       	kanban2.setNom("TP GUI");
       	dao6.save(kanban2);
    	
    	SectionDao dao3 = new SectionDao();
    	Section sec1 = new Section("Neda",kanban);
    	sec1.setNom("A faire");
    	dao3.save(sec1);
    	
    	SectionDao dao4 = new SectionDao();
    	Section sec2 = new Section("Neda", kanban1);
    	sec2.setNom("En cours ");
    	dao4.save(sec2);
    	
    	SectionDao dao5 = new SectionDao();
    	Section sec3 = new Section("Neda",kanban2);
    	sec3.setNom("Terminer");
    	dao3.save(sec3);
    	/*
